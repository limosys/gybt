...
pub struct ApiGetJupiterQuotesResponse {
    ...
    pub routes: Option<Vec<models::ApiJupiterQuoteRoute>>,
}

impl ApiGetJupiterQuotesResponse {
    pub fn new() -> ApiGetJupiterQuotesResponse {
