...
pub struct ApiGetOrderbookResponseV2 {
    ...
    pub bids: Option<Vec<models::ApiOrderbookItemV2>>,
    #[serde(rename = "asks", skip_serializing_if = "Option::is_none")]
    pub asks: Option<Vec<models::ApiOrderbookItemV2>>,
}

impl ApiGetOrderbookResponseV2 {
    pub fn new() -> ApiGetOrderbookResponseV2 {
