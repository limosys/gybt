...
pub struct ApiPostRaydiumRouteSwapRequest {
    #[serde(rename = "ownerAddress", skip_serializing_if = "Option::is_none")]
    pub owner_address: Option<String>,
    #[serde(rename = "steps", skip_serializing_if = "Option::is_none")]
    pub steps: Option<Vec<models::ApiRaydiumRouteStep>>,
...
impl ApiPostRaydiumRouteSwapRequest {
    pub fn new() -> ApiPostRaydiumRouteSwapRequest {
