...
pub struct ApiPostReplaceOrderRequest {
...
impl ApiPostReplaceOrderRequest {
    pub fn new(owner_address: String, payer_address: String, market: String, r#type: Vec<models::CommonOrderType>, amount: f64, price: f64, open_orders_address: String) -> ApiPostReplaceOrderRequest {
