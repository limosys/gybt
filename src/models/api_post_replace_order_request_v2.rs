...
pub struct ApiPostReplaceOrderRequestV2 {
...
impl ApiPostReplaceOrderRequestV2 {
    pub fn new(owner_address: String, payer_address: String, market: String, side: String, r#type: String, amount: f64, price: f64, open_orders_address: String) -> ApiPostReplaceOrderRequestV2 {
