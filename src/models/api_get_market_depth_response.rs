...
pub struct ApiGetMarketDepthResponse {
    ...
    pub bids: Option<Vec<models::ApiMarketDepthItem>>,
    #[serde(rename = "asks", skip_serializing_if = "Option::is_none")]
    pub asks: Option<Vec<models::ApiMarketDepthItem>>,
}

impl ApiGetMarketDepthResponse {
    pub fn new() -> ApiGetMarketDepthResponse {
