...
pub struct ApiPostOrderRequest {
    ...
    #[serde(rename = "type")]
    pub r#type: Vec<models::CommonOrderType>,
    #[serde(rename = "amount")]
    pub amount: f64,
    #[serde(rename = "price")]
    pub price: f64,
    /// If left empty the Openbook API will lookup the account which can be time consuming
    ...
    /// Optional: specifies a tip amount that can be sent to bundle multiple transactions. Minimum value is 1025.
...
impl ApiPostOrderRequest {
    pub fn new(owner_address: String, payer_address: String, market: String, r#type: Vec<models::CommonOrderType>, amount: f64, price: f64) -> ApiPostOrderRequest {
        ApiPostOrderRequest {
            owner_address,
            payer_address,
            market,
